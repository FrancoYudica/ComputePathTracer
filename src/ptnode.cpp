...
{
    ClassDB::bind_method(D_METHOD("set_material", "material"), &PTNode::set_material);
    ClassDB::bind_method(D_METHOD("get_material"), &PTNode::get_material);

    ClassDB::bind_method(D_METHOD("set_node_type", "node_type"), &PTNode::set_node_type);
    ClassDB::bind_method(D_METHOD("get_node_type"), &PTNode::get_node_type);

    ADD_PROPERTY(PropertyInfo(Variant::INT, "node_type", PROPERTY_HINT_ENUM, "TriangleMesh,Sphere"), "set_node_type", "get_node_type");
    ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "material", PROPERTY_HINT_RESOURCE_TYPE, "PTMaterial"), "set_material", "get_material");
...
godot::PTNodeType godot::PTNode::get_node_type() const
{
    return node_type;
}
